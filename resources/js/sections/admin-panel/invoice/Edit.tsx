...
export default function InvoiceEdit() {
  ...
  return (
    <MainCard className="table-card">
      <Row className="g-3 p-4">
        ...
        <Col xl={3} sm={6}>
          <div>
            ...
            <InputGroup>
              <Form.Select aria-describedby="basic-addon3" defaultValue="Paid">
      ...
      <Row className="g-3">
        <Col xs={12}>
          <h5 className="mb-3 px-4">Detail</h5>
          <Table responsive hover className="mb-0 border-bottom">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>
                  <Form.Control type="text" placeholder="Name" defaultValue="Apple Series 4 GPS A38 MM Space" />
                </td>
                <td>
                  <Form.Control
                    type="text"
                    placeholder="Description"
                    defaultValue="Apple Watch SE Smartwatch"
                    aria-describedby="basic-addon3"
                  />
                </td>
                <td>
                  <Form.Control type="number" placeholder="Qty" defaultValue="3" aria-describedby="basic-addon3" />
                </td>
                <td>
                  <Form.Control type="number" placeholder="Price" defaultValue="275.00" aria-describedby="basic-addon3" />
                </td>
                <td>₹825.00</td>
                <td>
              ...
              <tr>
                <td>1</td>
                <td>
                  <Form.Control type="text" placeholder="Name" defaultValue="Boat On-Ear Wireless" aria-describedby="basic-addon3" />
                </td>
                <td>
                  <Form.Control
                    type="text"
                    placeholder="Description"
                    defaultValue="Mic Bluetooth 4.2, Rockerz 450R"
                    aria-describedby="basic-addon3"
                  />
                </td>
                <td>
                  <Form.Control type="number" placeholder="Qty" defaultValue="45" aria-describedby="basic-addon3" />
                </td>
                <td>
                  <Form.Control type="number" placeholder="Price" defaultValue="81.99" aria-describedby="basic-addon3" />
                </td>
                <td>₹3689.55</td>
                <td>
                  <a href="#" className="avatar avatar-s btn-link-danger btn-pc-default mx-1">
              ...
              <tr>
                <td>1</td>
                <td>
                  <Form.Control type="text" placeholder="Name" defaultValue="Fitbit MX30 Smart Watch" aria-describedby="basic-addon3" />
                </td>
                <td>
                  <Form.Control
                    type="text"
                    placeholder="Description"
                    defaultValue="(MX30- waterproof) watch"
                    aria-describedby="basic-addon3"
                  />
                </td>
                <td>
                  <Form.Control type="number" placeholder="Qty" defaultValue="70" aria-describedby="basic-addon3" />
                </td>
                <td>
                  <Form.Control type="number" placeholder="Price" defaultValue="85.00" aria-describedby="basic-addon3" />
                </td>
                <td>₹5950.00</td>
                <td>
                  <a href="#" className="avatar avatar-s btn-link-danger btn-pc-default mx-1">
            ...
            <Row>
              <Col xs={6}>
                <div className="mb-3">
                  ...
                  <Form.Control type="number" defaultValue="0.5" aria-describedby="basic-addon3" />
                </div>
              </Col>
              <Col xs={6}>
                <div className="mb-3">
                  <Form.Label htmlFor="basic-url">Taxes(%)</Form.Label>
                  <Form.Control type="number" defaultValue="0.2" aria-describedby="basic-addon3" />
                </div>
              </Col>
              <Col xs={6}>
